        ...
        if (isLogIN) {
          ...
          UserCredential authResult = await FirebaseAuth.instance
              .createUserWithEmailAndPassword(
                  email: _osemail.trim(), password: _ospassword.trim());
          await FirebaseFirestore.instance.collection('emails').doc(authResult.user.uid).set({
...
ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(
      ...
      content:
      Text('Check your password and Email again' , style: TextStyle(color: Color(0xff2D2940)),),
    )
);
      }
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(  //21282D
